...
# Generated on: 2025-09-08 08:35:41 UTC

pkgname=windsurf-next
pkgver=1.12.109_next.261f5a0003
pkgrel=1
...
_pkgfilename="windsurf-next_1.12.109_next.261f5a0003_linux-x64"

source=(
    # Download the main binary, renaming it using :: syntax
    "$_pkgfilename::https://windsurf-stable.codeiumdata.com/linux-x64/next/261f5a0003a1ae326e60908915a4adaa291fb34a/Windsurf-linux-x64-1.12.109+next.261f5a0003.tar.gz"
    # Include the local .desktop file
    'windsurf-next.desktop'
    # Include the URL handler .desktop file
    'windsurf-next-url-handler.desktop'
)
sha256sums=('f01a88ae54f4aba0211be89b98728e5a8999e1d157cd8ba8ed27120b24d2d282'
