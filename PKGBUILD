...
# Generated on: 2025-09-28 13:12:14 UTC

pkgname=windsurf-next
pkgver=1.12.117_next.869df67af2
pkgrel=1
...
_pkgfilename="windsurf-next_1.12.117_next.869df67af2_linux-x64"

source=(
    # Download the main binary, renaming it using :: syntax
    "$_pkgfilename::https://windsurf-stable.codeiumdata.com/linux-x64/next/869df67af2a3134ce6fe3d8395ac0ae23726fd02/Windsurf-linux-x64-1.12.117+next.869df67af2.tar.gz"
    # Include the local .desktop file
    'windsurf-next.desktop'
    # Include the URL handler .desktop file
    'windsurf-next-url-handler.desktop'
)
sha256sums=('212c7646a18562bf96ebb3f46074b38501c5d7509a4a726db7733224f441685d'
