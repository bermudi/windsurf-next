...
# Generated on: 2025-11-23 11:41:26 UTC

pkgname=windsurf-next
pkgver=1.12.152_next.fb9435d9a4
pkgrel=1
...
_pkgfilename="windsurf-next_1.12.152_next.fb9435d9a4_linux-x64"

source=(
    # Download the main binary, renaming it using :: syntax
    "$_pkgfilename::https://windsurf-stable.codeiumdata.com/linux-x64/next/fb9435d9a4d89c681a097318dfac4546738ce05c/Windsurf-linux-x64-1.12.152+next.fb9435d9a4.tar.gz"
    # Include the local .desktop file
    'windsurf-next.desktop'
    # Include the URL handler .desktop file
    'windsurf-next-url-handler.desktop'
)
sha256sums=('2fef85734395e688b484dcecc6396a5705e19e82d1b72d154ad4eb6b1778472d'
